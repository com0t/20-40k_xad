...
class Age_Gate_Presentation extends Age_Gate_Public
{
    ...
    public function enqueue_scripts()
    {
         ...
         * class.
         */
        if ($this->settings['restrictions']['stepped'] && $this->settings['restrictions']['input_type'] === 'inputs') {
            wp_enqueue_script($this->plugin_name . '-stepped', plugin_dir_url(__FILE__) . 'js/stepped.js', array('jquery'), $this->version, true);
        }
        ...
        if ($this->settings['appearance']['auto_tab'] && !$this->settings['restrictions']['stepped']) {
